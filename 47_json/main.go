...
func main() {
	...
	// We can also decode JSON into custom data types. This has the advantages of adding additional type-safety to
	// our programs and eliminating the need for type assertions when accessing the decoded data.
